...
(R-1RK), feature by feature. Of the report's 135 feature entries, **57 are verified
by a behavioural check, 12 resolve but are unchecked, and 66 are absent**; 34 belong
...
Chapter 12's required **Numbers** module (12.5) is complete, as is the optional
**Rational** module (12.8) — the latter over the existing numeric types, since
IronKernel has no exact rational representation. The remaining numeric modules
(Inexact, Narrow inexact, Real, Complex) are not implemented.
