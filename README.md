...
implemented over the existing numeric types, since IronKernel has no exact rational
representation. Only **Inexact** (12.6) and **Narrow inexact** (12.7) remain, and
they are what the exactness divergences rest on.
